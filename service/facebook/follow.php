            ...
            <div class="card-header bg-light">
                <div class="row justify-content-between">
                    ...
                    <div class="col-md-auto"><a class="btn btn-falcon-default btn-sm"
                            href="/service/facebook/follow/list"><span class="fas fa-list fs--2 mr-1"></span> Order List</a>
                    </div>
                </div>
            </div>
            <div class="card-body bg-light">
                ...
                <form action="" id="form_id" class="user" method="POST" accept-charset="utf-8">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" id="buff_fb_id" name="idfb" class="form-control"
                            placeholder="Enter Link Post You Want Increase" required="">
                    ...
                    <center>
                        <button type="button" class="btn btn-success btn-rounded me-1 mb-1" id="followFacebook"
                            onclick="follow_facebook();"><i class="fa fa-dollar-sign"></i> Buy</button>
                    </center>
                </form>
                </p>
            </div>
...
function follow_facebook() {
    ...
    $.ajax({
        ...
        complete: function() {
            wait('#followFacebook', true, '<i class="fa fa-dollar-sign"></i> Buy');
        },
        success: (data) => {
            if (data.error) {
                swal(data.msg, "error");
